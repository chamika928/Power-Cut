...
<head>
  ...
  <script type="text/javascript" src="http://ff.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=YufbkKHt1tb_aJj9WdfwfB0O_HgXp7zYLg9sZwVN_BpZncADdEern6q50jh6BU_efUSlDjAbGnnIf3iVGhsLDKh4V40Ha0zBQ0qYONG_dNc" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2863040884ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electriproject&table=powercutm">`electriproject`.`powercutm`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=power+cut&table=powercut">`power cut`.`powercut`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=items">`test`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electriproject&table=customerm">`electriproject`.`customerm`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electriproject&table=billingm">`electriproject`.`billingm`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ordermedicine&table=order">`ordermedicine`.`order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hospital&table=medicine">`hospital`.`medicine`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2773776461323e474f2624244d454d29">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="electriproject" targettable="powercutm">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `powercutm`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="electriproject" targettable="powercutm">
                            <div class="action_content">
